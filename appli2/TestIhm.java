...
public class TestIhm
{
    public static void main(String[] args)
    {
        ...
        Cuve c1 = Cuve.creerCuve(200 , 50  , new Position(20 , 400), 0);
        Cuve c2 = Cuve.creerCuve(300 , 200 , new Position(50 , 400), 1);
        Cuve c3 = Cuve.creerCuve(500 , 0   , new Position(100, 100), 2);
        Cuve c4 = Cuve.creerCuve(700 , 500 , new Position(200, 100), 3);
